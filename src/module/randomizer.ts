...
function isRandomItemOptions(options: unknown): options is RandomItemOptions {
  return (
    isObject(options) && (options.type === undefined || (typeof options.type === 'string' && validType(options.type)))
  );
}
...
function calculateFinalRarity(prefix: Affix | undefined, suffix: Affix | undefined) {
  ...
  switch (true) {
    case itemRarity < Rarity.UNCOMMON:
      return Rarity.COMMON;
    case itemRarity < Rarity.RARE:
      return Rarity.UNCOMMON;
    case itemRarity < Rarity.VERY_RARE:
      return Rarity.RARE;
    case itemRarity < Rarity.LEGENDARY:
      return Rarity.VERY_RARE;
    default:
      return Rarity.LEGENDARY;
  }
