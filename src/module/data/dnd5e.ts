...
export const affixes: AffixData = {
  weapon: {
    prefixes: {
      ...
      [Rarity.RARE]: [{ label: 'Sacred(R)', effect: 'is sacred', rarity: Rarity.RARE }],
      [Rarity.VERY_RARE]: [
      ...
      [Rarity.LEGENDARY]: [{ label: 'Godly(L)', effect: 'is godly', rarity: Rarity.LEGENDARY }],
    },
    suffixes: {
      [Rarity.COMMON]: [
      ...
      [Rarity.RARE]: [{ label: 'the Deadly Hollows(R)', effect: 'is from the deadly hollows', rarity: Rarity.RARE }],
      [Rarity.VERY_RARE]: [{ label: 'Eons(VR)', effect: 'is old AF', rarity: Rarity.VERY_RARE }],
      [Rarity.LEGENDARY]: [{ label: 'Godslaying(L)', effect: 'is for killing gods', rarity: Rarity.LEGENDARY }],
    },
  },
  // equipment: {
  //     prefixes: [],
